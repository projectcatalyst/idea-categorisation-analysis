...
* **Time consuming handling malicious actors** - As challenge settings are a [competitive](../categorisation-analysis/inclusive-vs-exclusive-categorisation.md) approach to categorisation that are defined each funding round by the community there is an easy entrance for malicious actors to submit numerous challenge proposals to consistently try and game of break the funding process. Giving people this ability makes the funding process less efficient as more time is required to moderate and remove categorisations that were made with bad intentions.
